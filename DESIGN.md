# Frames Design System & Style Guide

Use this guide to configure Mintlify docs or any other platform to match the Frames brand.
...
- **No heavy shadows** — Frames uses a flat, minimal aesthetic
...
- **Logo**: "Frames" in `--font-display` at 600 weight
