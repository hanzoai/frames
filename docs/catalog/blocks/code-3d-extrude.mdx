...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/code-3d-extrude.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/code-3d-extrude.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx frames add code-3d-extrude
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-3d-extrude.html` | `compositions/code-3d-extrude.html` | frames:composition |
