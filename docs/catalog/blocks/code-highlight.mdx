...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-highlight.mp4" poster="/images/catalog/blocks/code-highlight.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-highlight
```
