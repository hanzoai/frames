...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-particle-assemble.mp4" poster="/images/catalog/blocks/code-particle-assemble.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-particle-assemble
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-particle-assemble.html` | `compositions/code-particle-assemble.html` | frames:composition |
