...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-shader-dissolve.mp4" poster="/images/catalog/blocks/code-shader-dissolve.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-shader-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-shader-dissolve.html` | `compositions/code-shader-dissolve.html` | frames:composition |
