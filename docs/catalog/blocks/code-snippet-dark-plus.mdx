...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-snippet-dark-plus.mp4" poster="/images/catalog/blocks/code-snippet-dark-plus.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-snippet-dark-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-plus.html` | `compositions/code-snippet-dark-plus.html` | frames:composition |
