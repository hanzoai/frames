...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-snippet-high-contrast-light.mp4" poster="/images/catalog/blocks/code-snippet-high-contrast-light.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-snippet-high-contrast-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-high-contrast-light.html` | `compositions/code-snippet-high-contrast-light.html` | frames:composition |
| `background.jpeg` | `assets/background.jpeg` | frames:asset |
