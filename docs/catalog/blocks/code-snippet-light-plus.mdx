...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/code-snippet-light-plus.mp4" poster="/images/catalog/blocks/code-snippet-light-plus.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add code-snippet-light-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-plus.html` | `compositions/code-snippet-light-plus.html` | frames:composition |
