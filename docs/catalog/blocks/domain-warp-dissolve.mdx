...
```bash Terminal
npx frames add domain-warp-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `domain-warp-dissolve.html` | `compositions/domain-warp-dissolve.html` | frames:composition |
