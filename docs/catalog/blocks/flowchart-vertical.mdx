...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/flowchart-vertical.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/flowchart-vertical.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx frames add flowchart-vertical
```
...
| File | Target | Type |
| --- | --- | --- |
| `flowchart-vertical.html` | `compositions/flowchart-vertical.html` | frames:composition |
