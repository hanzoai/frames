...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/ios26-liquid-glass.mp4" poster="/images/catalog/blocks/ios26-liquid-glass.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add ios26-liquid-glass
```
