...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/ios26-liquid-glass.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/ios26-liquid-glass.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx frames add ios26-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `ios26-liquid-glass.html` | `compositions/ios26-liquid-glass.html` | frames:composition |
| `models/iphone.glb` | `models/iphone.glb` | frames:asset |
| `lib/liquid-glass.iife.js` | `lib/liquid-glass.iife.js` | frames:asset |
