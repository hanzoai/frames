...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/liquid-glass-context-menu.mp4" poster="/images/catalog/blocks/liquid-glass-context-menu.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add liquid-glass-context-menu
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-context-menu.html` | `compositions/liquid-glass-context-menu.html` | frames:composition |
