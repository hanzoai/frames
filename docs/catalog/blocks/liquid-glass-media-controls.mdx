...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/liquid-glass-media-controls.mp4" poster="/images/catalog/blocks/liquid-glass-media-controls.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add liquid-glass-media-controls
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-media-controls.html` | `compositions/liquid-glass-media-controls.html` | frames:composition |
