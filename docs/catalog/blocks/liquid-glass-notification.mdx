...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/liquid-glass-notification.mp4" poster="/images/catalog/blocks/liquid-glass-notification.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add liquid-glass-notification
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-notification.html` | `compositions/liquid-glass-notification.html` | frames:composition |
