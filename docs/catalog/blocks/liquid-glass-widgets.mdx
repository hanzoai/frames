...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/liquid-glass-widgets.mp4" poster="/images/catalog/blocks/liquid-glass-widgets.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add liquid-glass-widgets
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-widgets.html` | `compositions/liquid-glass-widgets.html` | frames:composition |
