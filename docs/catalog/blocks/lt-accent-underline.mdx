...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/lt-accent-underline.mp4" poster="/images/catalog/blocks/lt-accent-underline.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add lt-accent-underline
```
...
| File | Target | Type |
| --- | --- | --- |
| `lt-accent-underline.html` | `compositions/lt-accent-underline.html` | frames:composition |
