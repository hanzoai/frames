...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/lt-bold-block.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/lt-bold-block.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `lt-bold-block.html` | `compositions/lt-bold-block.html` | frames:composition |
