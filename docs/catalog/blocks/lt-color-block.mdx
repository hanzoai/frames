...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/lt-color-block.mp4" poster="/images/catalog/blocks/lt-color-block.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add lt-color-block
```
