...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/lt-side-rule.mp4" poster="/images/catalog/blocks/lt-side-rule.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add lt-side-rule
```
