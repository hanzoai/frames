...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/macos-tahoe-liquid-glass.mp4" poster="/images/catalog/blocks/macos-tahoe-liquid-glass.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add macos-tahoe-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `macos-tahoe-liquid-glass.html` | `compositions/macos-tahoe-liquid-glass.html` | frames:composition |
| `models/macbook.glb` | `models/macbook.glb` | frames:asset |
