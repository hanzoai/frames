...
```bash Terminal
npx @hanzo/frames add north-korea-locked-down
```
...
| File | Target | Type |
| --- | --- | --- |
| `north-korea-locked-down.html` | `compositions/north-korea-locked-down.html` | frames:composition |
| `assets/korea-map.png` | `assets/korea-map.png` | frames:asset |
