...
```bash Terminal
npx frames add nyc-paris-flight
```
...
| File | Target | Type |
| --- | --- | --- |
| `nyc-paris-flight.html` | `compositions/nyc-paris-flight.html` | frames:composition |
| `assets/map-nyc-paris.png` | `assets/map-nyc-paris.png` | frames:asset |
| `assets/sfx-mix.wav` | `assets/sfx-mix.wav` | frames:asset |
