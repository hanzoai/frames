...
```bash Terminal
npx frames add transitions-destruction
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-destruction.html` | `compositions/transitions-destruction.html` | frames:composition |
