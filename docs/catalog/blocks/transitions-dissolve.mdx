...
```bash Terminal
npx frames add transitions-dissolve
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-dissolve.html` | `compositions/transitions-dissolve.html` | frames:composition |
