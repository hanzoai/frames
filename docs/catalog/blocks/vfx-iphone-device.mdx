...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/vfx-iphone-device.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/blocks/vfx-iphone-device.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx frames add vfx-iphone-device
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-iphone-device.html` | `compositions/vfx-iphone-device.html` | frames:composition |
| `models/iphone.glb` | `models/iphone.glb` | asset |
| `models/macbook.glb` | `models/macbook.glb` | asset |
| `models/frames-mobile.png` | `models/frames-mobile.png` | asset |
| `models/frames-desktop.png` | `models/frames-desktop.png` | asset |
