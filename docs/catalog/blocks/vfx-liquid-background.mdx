...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/vfx-liquid-background.mp4" poster="/images/catalog/blocks/vfx-liquid-background.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add vfx-liquid-background
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-liquid-background.html` | `compositions/vfx-liquid-background.html` | frames:composition |
