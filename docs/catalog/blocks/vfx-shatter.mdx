...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/blocks/vfx-shatter.mp4" poster="/images/catalog/blocks/vfx-shatter.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add vfx-shatter
```
