...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/components/caption-blend-difference.mp4" poster="/images/catalog/components/caption-blend-difference.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add caption-blend-difference
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-blend-difference.html` | `compositions/components/caption-blend-difference.html` | frames:snippet |
