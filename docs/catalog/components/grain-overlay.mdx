...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/frames-oss/docs/images/catalog/components/grain-overlay.mp4" poster="https://static.heygen.ai/frames-oss/docs/images/catalog/components/grain-overlay.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `grain-overlay.html` | `compositions/components/grain-overlay.html` | frames:snippet |
