...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="/images/catalog/components/motion-blur.mp4" poster="/images/catalog/components/motion-blur.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx @hanzo/frames add motion-blur
```
