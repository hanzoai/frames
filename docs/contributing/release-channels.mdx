...
description: How Frames keeps alpha-only work out of stable releases.
---

Frames publishes two release channels:
...
```bash
npm install frames@alpha
npm install @frames/core@alpha
```
