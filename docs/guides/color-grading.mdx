...
npx @hanzo/frame media-treatment --capability curves --json
```
...
```bash Terminal
npx @hanzo/frame media-treatment --capability secondary --json
npx @hanzo/frame media-treatment --all --json
```
