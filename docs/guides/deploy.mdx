...
- **Author locally**, deploy the preview + render API. Compositions are still built on your machine with `npx @hanzo/frames init`, then dropped into the template's compositions directory.
