  ...
  <Tab title="Claude.ai">
    <Steps>
      ...
      <Step title="Sign in to HeyGen">
        OAuth opens in a new window. Authorize the Frames connector to access your HeyGen account.
      </Step>
...
<AccordionGroup>
  <Accordion title="OAuth keeps failing or loops">
    Verify you're using the production URL: `https://mcp.hanzo.ai/mcp/frames`. The dev URL (`mcp.dev.heygen.com`) only accepts dev accounts.
