...
<Tabs>
  ...
  <Tab title="Agent / CLI">
    ...
    npx frames media-treatment --capability digitalGlitch --json
...
```bash Terminal
npx frames media-treatment --capabilities --json
npx frames media-treatment --capability retro-glitch --json
npx frames media-treatment --capability digitalGlitch --json
```
...
```bash Terminal
npx frames media-treatment --capability palettes --json
npx frames media-treatment --capability electric-ink --json
```
