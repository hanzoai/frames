...
<Tabs>
  ...
  <Tab title="Agent / CLI">
    ...
    npx @hanzo/frame media-treatment --capability digitalGlitch --json
...
```bash Terminal
npx @hanzo/frame media-treatment --capabilities --json
npx @hanzo/frame media-treatment --capability retro-glitch --json
npx @hanzo/frame media-treatment --capability digitalGlitch --json
```
...
```bash Terminal
npx @hanzo/frame media-treatment --capability palettes --json
npx @hanzo/frame media-treatment --capability electric-ink --json
```
