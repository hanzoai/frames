---
title: "@frames/shader-transitions"
description: "WebGL shader transitions for Frames scenes and compositions."
---

The shader transitions package adds GPU-accelerated scene-to-scene transitions to Frames compositions. It captures scene samples, uploads them as WebGL textures, and drives fragment-shader compositing from a GSAP timeline.
...
**Use `@frames/shader-transitions` when you need to:**
