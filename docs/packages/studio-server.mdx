...
<Tip>
  **Most users do not need this package directly.** The [CLI](/packages/cli) (`npx @hanzo/frame preview`) and [studio](/packages/studio) wire it up for you. Reach for it when you're **embedding** the studio backend into your own server.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="CLI" icon="terminal" href="/packages/cli">
    `npx @hanzo/frame preview` wires this server up for you.
  </Card>
</CardGroup>
