...
<Steps>
  <Step title="Scaffold the project">
    ...
    ```bash
    npx @hanzo/frames init my-video --non-interactive --example blank
    ```
    ...
    ```bash
    npx @hanzo/frames init my-video --example warm-grain --video ./intro.mp4
    ```

    `frames init` installs AI agent skills automatically, so you can hand off to your AI agent at any point.
  </Step>
