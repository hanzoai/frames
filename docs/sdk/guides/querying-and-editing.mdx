...
Each `ElementSnapshot` (aliased from `FramesElement`) carries:
...
```typescript
import type { FindQuery } from "@frames/sdk";
...
<CardGroup cols={2}>
  ...
  <Card title="Types reference" icon="brackets-curly" href="/sdk/reference/types">
    FramesElement, FindQuery, ElementHandle, SelectionProxy, and more.
  </Card>
