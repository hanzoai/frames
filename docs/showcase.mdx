...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-5 my-8">
  ...
  >
    <video
      ...
      src="https://static.heygen.ai/frames-oss/docs/images/showcase/frames-launch-preview.mp4"
      poster="https://static.heygen.ai/frames-oss/docs/images/showcase/frames-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/frames-oss/docs/images/showcase/website-to-frames-preview.mp4"
      poster="https://static.heygen.ai/frames-oss/docs/images/showcase/website-to-frames-poster.jpg"
      controls
      muted
      loop
      playsInline
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/frames-oss/docs/images/showcase/timeline-editor-preview.mp4"
      poster="https://static.heygen.ai/frames-oss/docs/images/showcase/timeline-editor-poster.jpg"
      controls
      muted
      loop
      playsInline
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/frames-oss/docs/images/showcase/texture-launch-preview.mp4"
      poster="https://static.heygen.ai/frames-oss/docs/images/showcase/texture-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/frames-oss/docs/images/showcase/vfx-heygen-preview.mp4"
      poster="https://static.heygen.ai/frames-oss/docs/images/showcase/vfx-heygen-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
        href="https://github.com/hanzoai/frames-launches/tree/main/vfx-heygen-combined"
      >
        View source ->
      </a>
    </div>
...
| An effects-heavy launch reel | [VFX x HeyGen combined](https://github.com/hanzoai/frames-launches/tree/main/vfx-heygen-combined) | Shows Three.js, generated media, and HTML-in-canvas in one render. |
| A starter project | [Examples](/examples) | Scaffold working templates with `npx frames init --example <name>`. |
...
<CardGroup cols={2}>
  <Card title="Starter Examples" icon="layer-group" href="/examples">
    Scaffold remixable templates with `npx frames init --example`.
  </Card>
