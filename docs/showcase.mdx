...
| A starter project | [Examples](/examples) | Scaffold working templates with `npx @hanzo/frame init --example <name>`. |
...
<CardGroup cols={2}>
  <Card title="Starter Examples" icon="layer-group" href="/examples">
    Scaffold remixable templates with `npx @hanzo/frame init --example`.
  </Card>
