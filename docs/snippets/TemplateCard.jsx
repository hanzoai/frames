export function TemplateCard({ id, title, description, href, portrait }) {
  ...
  const imgSrc = `https://static.heygen.ai/frames-oss/docs/images/templates/${id}.png`;
  const videoSrc = `https://static.heygen.ai/frames-oss/docs/images/templates/${id}.mp4`;
