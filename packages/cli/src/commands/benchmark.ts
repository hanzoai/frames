...
const FPS_30: import("@hanzo/frames-core").Fps = { num: 30, den: 1 };
const FPS_60: import("@hanzo/frames-core").Fps = { num: 60, den: 1 };
    ...
    try {
      ...
      if (jsonOutput) {
        ...
        errorBox(
          ...
          "Ensure @hanzo/frames-producer is built and linked.",
        );
      }
      failCommand();
    }
