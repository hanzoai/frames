...
export const examples: Example[] = [
  ["Capture a website into ./capture/", "frames capture https://stripe.com"],
  ["Capture to a different directory", "frames capture https://linear.app -o linear-video"],
  ["JSON output for AI agents", "frames capture https://example.com --json"],
  [
    "Pull a video from the captured manifest by index",
    "frames capture --video ./linear-video --index 0",
  ],
  [
    "List videos referenced in the captured manifest",
    "frames capture --video ./linear-video --list",
  ],
];
...
export default defineCommand({
  meta: {
    name: "capture",
    description: "Capture a website as editable Frames components",
  },
  args: {
    url: {
      type: "positional",
