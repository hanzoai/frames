...
export const examples: Example[] = [
  ["List all available topics", "frames docs"],
  ["Read about data attributes", "frames docs data-attributes"],
  ["Read about rendering", "frames docs rendering"],
  ["Read about GSAP integration", "frames docs gsap"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    if (topic === undefined || topic === "") {
      ...
      console.log();
      console.log(c.dim(`Run ${c.accent("frames docs <topic>")} to view a topic.`));
      return;
    }
