/**
 * `frames figma` — import figma assets, tokens, and components over
...
export const examples: Example[] = [
  [
    ...
    "frames figma asset 'https://www.figma.com/design/KEY/T?node-id=1-2'",
  ],
  ["Import as PNG at 2x", "frames figma asset KEY:1-2 --format png --scale 2"],
  ["Pull brand tokens into the composition", "frames figma tokens KEY"],
  ["Import a frame as an editable HTML component", "frames figma component KEY:10-20"],
];

const HELP = `
${c.bold("frames figma")} ${c.dim("<subcommand> [args]")}
