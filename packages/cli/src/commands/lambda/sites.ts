...
// `@hanzo/frames-aws-lambda` is a workspace devDependency in `packages/cli`
...
async function loadSDK(): Promise<typeof import("@hanzo/frames-aws-lambda/sdk")> {
  return import("@hanzo/frames-aws-lambda/sdk");
}
