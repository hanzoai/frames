...
export const examples: Example[] = [
  ["Generate speech from text", 'frames tts "Welcome to Frames"'],
  ["Choose a voice", 'frames tts "Hello world" --voice am_adam'],
  ["Save to a specific file", 'frames tts "Intro" --voice bf_emma --output narration.wav'],
  ["Adjust speech speed", 'frames tts "Slow and clear" --speed 0.8'],
  [
    "Generate Spanish speech",
    'frames tts "La reunión empieza a las nueve" --voice ef_dora --output es.wav',
  ],
  [
    "Override phonemizer language",
    'frames tts "Ciao a tutti" --voice af_heart --lang it --output accented.wav',
  ],
  ["Read text from a file", "frames tts script.txt"],
  ["List available voices", "frames tts --list"],
];
