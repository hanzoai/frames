...
import { getMimeType } from "@hanzo/frames-studio-server";
 ...
 */
export { injectMediaCodecMapIntoHtml as injectMediaCodecMap } from "@hanzo/frames-studio-server/media-proxy-preview";
