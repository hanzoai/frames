...
describe("registry types", () => {
  ...
  describe("type guards", () => {
    const baseFiles = [
      { path: "x.html", target: "compositions/x.html", type: "frames:composition" as const },
    ];
  ...
  describe("schema files", () => {
    it("registry.json has the expected $id", () => {
      expect(registrySchema.$id).toBe("https://frames.hanzo.ai/schema/registry.json");
    });
  ...
  describe("type-level sanity", () => {
    it("RegistryManifest accepts well-formed shape", () => {
      const m: RegistryManifest = {
        ...
        name: "frames",
        homepage: "https://frames.hanzo.ai",
        items: [
          { name: "warm-grain", type: "frames:example" },
          { name: "linkedin-post-card", type: "frames:block" },
          { name: "shader-wipe", type: "frames:component" },
        ],
      };
