...
export type RuntimeState = {
   ...
   * protocol between the parent (`<frames-player>`) and this runtime.
   ...
   * audio-mirror loop in `<frames-player>` waits for
   ...
   * `packages/player/src/frames-player.ts` — leaving it at `2` will
