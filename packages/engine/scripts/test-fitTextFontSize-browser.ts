 ...
 *
 * Requires: puppeteer (dep of @frames/engine)
...
<script>
  ...
  var r3 = window.__frames.fitTextFontSize(
  ...
  window.__testResults.exists = typeof window.__frames.fitTextFontSize === "function";
</script>
</body></html>`;
  ...
  try {
    ...
    assert(results.exists === true, "fitTextFontSize should exist on window.__frames");
    assert(
