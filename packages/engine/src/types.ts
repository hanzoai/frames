/**
 * @hanzo/frame-engine — Protocol Types
 *
 ...
 *
 * Compositions using @hanzo/frame-shader-transitions populate
...
export interface HfProtocol {
  ...
  /** Optional: shader transition metadata, populated by @hanzo/frame-shader-transitions */
