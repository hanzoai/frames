 ...
 *
 * These shapes are intentionally identical to `@hanzo/frames-aws-lambda`'s
...
export type { SerializableDistributedRenderConfig } from "@hanzo/frames-producer/distributed";
