...
import { checkSubCompositionUsability } from "@hanzo/frames-parsers/sub-composition-validity";
...
import type { ParsableDocumentLike } from "@hanzo/frames-parsers/sub-composition-validity";
