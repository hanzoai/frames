 ...
 * `@frames/parsers` (rather than `@frames/core`, where it
 * originated) because `@frames/lint` needs it too, and `lint` cannot
 ...
 *
 * `inlineSubCompositions.ts` (in `@frames/core`) intentionally stays
