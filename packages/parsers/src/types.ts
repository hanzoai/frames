...
// Moved from @hanzo/frames-core/core.types in the parsers extraction refactor.
 ...
 * stage (`@hanzo/frames-producer`) and `suggestMatchingPreset` here.
 *
 ...
 * compile stage (`@hanzo/frames-producer`) for the canonical remap.
 */
