...
import { parseFps, fpsToNumber } from "@frames/core";
import {
...
// `@frames/aws-lambda`, which depends on @aws-sdk + @sparticuz/chromium.
...
// `@frames/aws-lambda`, whose types come from `dist/index.d.ts` after
...
// pulls `regression-harness-lambda-local.ts` (and its `@frames/aws-lambda`
...
type CliOptions = {
   ...
   * `@frames/producer/distributed`. See
