 ...
 *
 *   1. `import { plan, renderChunk, assemble } from "@hanzo/frame-producer"`
 *      — the canonical package entry. Includes the three activity functions
 *      and their result types.
 *
 *   2. `import { plan, renderChunk, assemble } from "@hanzo/frame-producer/distributed"`
 ...
 * `../../index.js` paths rather than `"@hanzo/frame-producer"` because the
...
describe("@hanzo/frame-producer/distributed (subpath)", () => {
...
describe("@hanzo/frame-producer (main entry)", () => {
