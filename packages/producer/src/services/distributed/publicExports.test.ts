 ...
 *
 *   1. `import { plan, renderChunk, assemble } from "@hanzo/frames-producer"`
 *      — the canonical package entry. Includes the three activity functions
 *      and their result types.
 *
 *   2. `import { plan, renderChunk, assemble } from "@hanzo/frames-producer/distributed"`
 ...
 * `../../index.js` paths rather than `"@hanzo/frames-producer"` because the
...
describe("@hanzo/frames-producer/distributed (subpath)", () => {
...
describe("@hanzo/frames-producer (main entry)", () => {
