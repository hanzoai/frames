...
// `readWebGlVendorInfoFromCanvas` lives in `@hanzo/frames-engine` (it's
...
// `@hanzo/frames-producer/distributed` keep working.
export { readWebGlVendorInfoFromCanvas } from "@hanzo/frames-engine";
