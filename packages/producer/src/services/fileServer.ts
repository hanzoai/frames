...
import { injectScriptsAtHeadStart, injectScriptsIntoHtml } from "@hanzo/frames-core/compiler";
import { fpsToNumber, type Fps } from "@hanzo/frames-core";
 ...
 * page. The flag is read by `@hanzo/frames-shader-transitions`' engine-mode
 ...
 * `@hanzo/frames-shader-transitions` and is loaded by the composition's
 ...
 * @hanzo/frames-shader-transitions) are preserved through to engine query time.
 */
