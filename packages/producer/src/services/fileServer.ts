...
import { injectScriptsAtHeadStart, injectScriptsIntoHtml } from "@hanzo/frame-core/compiler";
import { fpsToNumber, type Fps } from "@hanzo/frame-core";
 ...
 * page. The flag is read by `@hanzo/frame-shader-transitions`' engine-mode
 ...
 * `@hanzo/frame-shader-transitions` and is loaded by the composition's
 ...
 * @hanzo/frame-shader-transitions) are preserved through to engine query time.
 */
