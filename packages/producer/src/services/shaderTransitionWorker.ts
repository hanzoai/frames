...
// subpath export of `@frames/engine` rather than the package root.
// Rationale:
//
...
//    redirects `@frames/engine/shader-transitions` to the same TS
//    source and bundles it inline, so behavior is identical.
import { TRANSITIONS, crossfade } from "@frames/engine/shader-transitions";
