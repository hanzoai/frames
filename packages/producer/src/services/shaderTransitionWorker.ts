...
// subpath export of `@hanzo/frame-engine` rather than the package root.
// Rationale:
//
...
//    redirects `@hanzo/frame-engine/shader-transitions` to the same TS
//    source and bundles it inline, so behavior is identical.
import { TRANSITIONS, crossfade } from "@hanzo/frame-engine/shader-transitions";
