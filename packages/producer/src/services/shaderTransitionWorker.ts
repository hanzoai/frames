...
// subpath export of `@hanzo/frames-engine` rather than the package root.
// Rationale:
//
...
//    redirects `@hanzo/frames-engine/shader-transitions` to the same TS
//    source and bundles it inline, so behavior is identical.
import { TRANSITIONS, crossfade } from "@hanzo/frames-engine/shader-transitions";
