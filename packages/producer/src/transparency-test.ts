 ...
 * this script via `bun run --filter @hanzo/frames-producer test:transparency`
...
import { decodePng, runFfmpeg } from "@hanzo/frames-engine";
...
const WIDTH = 200;
const HEIGHT = 200;
const FPS: import("@hanzo/frames-core").Fps = { num: 30, den: 1 };
