 ...
 * this script via `bun run --filter @frames/producer test:transparency`
...
import { decodePng, runFfmpeg } from "@frames/engine";
...
const WIDTH = 200;
const HEIGHT = 200;
const FPS: import("@frames/core").Fps = { num: 30, den: 1 };
