 ...
 * this script via `bun run --filter @hanzo/frame-producer test:transparency`
...
import { decodePng, runFfmpeg } from "@hanzo/frame-engine";
...
const WIDTH = 200;
const HEIGHT = 200;
const FPS: import("@hanzo/frame-core").Fps = { num: 30, den: 1 };
