...
// can type declarations without a direct @hanzo/frames-core dependency.
export type {
  CompositionVariable,
...
// Concrete adapter factories (browser-safe — Node-only fs adapter: @hanzo/frames-sdk/adapters/fs).
