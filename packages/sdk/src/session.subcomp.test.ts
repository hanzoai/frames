...
import { ensureHfIds } from "@frames/core/hf-ids";
import { RUNTIME_BOOTSTRAP_ATTR } from "@frames/core";
...
describe("serialize({ stripRuntime })", () => {
  const RUNTIME_SCRIPT =
    '<script data-frames-preview-runtime="1" src="https://cdn.jsdelivr.net/npm/@frames/core/dist/hyperframe.runtime.iife.js"></script>';
  ...
  it("re-exports RUNTIME_BOOTSTRAP_ATTR from @frames/core, matching the marker generators stamp", async () => {
