...
import { injectScriptsIntoHtml, stripEmbeddedRuntimeScripts } from "@hanzo/frames-core/compiler";
import { isWithinProjectRoot } from "@hanzo/frames-parsers/asset-resolution";
