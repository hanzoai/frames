...
import { isLottieAnimationLoaded } from "@hanzo/frames-core/runtime/lottie-readiness";
import { useMountEffect } from "../../hooks/useMountEffect";
import { applyPreviewVariablesToUrl } from "../../hooks/previewVariablesStore";
import { HyperframesLoader } from "../../components/ui";
// NOTE: importing "@hanzo/frames-player" registers a class extending HTMLElement
...
export const Player = forwardRef<HTMLIFrameElement, PlayerProps>(
  (
    ...
    useMountEffect(() => {
      ...
      import("@hanzo/frames-player").then(() => {
        if (canceled) return;
