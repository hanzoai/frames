...
export function buildTimelineAgentPrompt({
  ...
  return `Edit the following Frames composition:
...
The composition uses Frames data attributes (data-start, data-duration, data-track-index) and GSAP for animations.
