...
//   localStorage.setItem('frames-studio:telemetryDisabled','1')
// ---------------------------------------------------------------------------
...
const NOTICE_KEY = "frames-studio:telemetryNoticeShown";
...
const SESSION_FIRED_KEY = "frames-studio:sessionStartFired";
