...
Caption at exactly t=0 feels like it was there before the video started. Offset 0.1-0.3s (frames motion-principles.md agrees). Same for the very last caption — let it exit before the video fades.
