 ...
 *
 * frames' renderer only auto-supplies its ~18 CANONICAL_FONTS. Every other
 ...
 * On a clean/offline/CI machine it silently degrades. (frames' own font
 ...
 * HTML, frames-canonical families, and CSS generics are left untouched.
 *
...
// inline style="") and the data-font-family attribute frames also honors.
