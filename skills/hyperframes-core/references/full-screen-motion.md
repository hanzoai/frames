...
- **Verify intentional overflow with snapshots.** Before adding `data-layout-allow-overflow` to silence an inspect warning, run `npx @hanzo/frame snapshot` and confirm the overflow is what you want.
