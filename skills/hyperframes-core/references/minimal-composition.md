...
The smallest renderable Frames composition — a standalone (top-level) root with one clip and one tween:
...
<html lang="en">
  <head>
    ...
    <title>Minimal Frames Composition</title>
