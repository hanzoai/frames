...
**Shader transitions** — 14 built-in WebGL GPU effects. Install with `npx frames add <name>` (block name ≠ shader name — see `skills/frames-registry/references/discovery.md`); full API in `packages/shader-transitions/README.md`.
