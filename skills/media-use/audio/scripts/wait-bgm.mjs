...
//
// Usage:
//   node wait-bgm.mjs --audio-meta ./audio_meta.json --frames . \
...
const outPath = resolve(flag("out", join(framesDir, "bgm_status.json")));
...
const bgmAbsPath = bgmPath ? join(framesDir, bgmPath) : "";
